...
@section('js')
  <script src="{{ asset("assets/js/views/main.js") }}" type="text/javascript"></script>
@stop
@section('section')
  <div class="row">
      ...
      <div class="card card-inverse card-primary">
        <div class="card-block pb-0">
          <div class="btn-group float-right">
            <button type="button" class="btn btn-transparent active dropdown-toggle p-0" data-toggle="dropdown"
              ...
              <ul class="horizontal-bars type-2">
                ...
                <li class="divider text-center">
                  <button type="button" class="btn btn-sm btn-link text-muted" data-toggle="tooltip"
                          data-placement="top" title="" data-original-title="show more"><i class="icon-options"></i>
                  </button>
                </li>
              </ul>
            </div>
